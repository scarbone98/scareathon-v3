    ...
    <AnimatedPage>
      <div className="animated-gradient min-h-screen flex items-center justify-center">
        <div className="container mx-auto px-4 py-8 max-w-2xl">
          <h1 className="text-4xl font-bold mb-8 text-center text-halloween-orange font-spooky">Rules</h1>
          <div className="prose prose-lg mx-auto font-spooky">
            <ul className="list-none p-0 space-y-4">
              {[
                ...
                <li key={index} className="grid grid-cols-[auto,1fr] gap-4 items-start text-lg text-pumpkin">
          ...
          <div className="mt-8 flex justify-center">
            <img
              src={isAnimating ? "/images/skelly.gif" : "/images/rip-tombstone.gif"}
              alt="Spooky Rules"
