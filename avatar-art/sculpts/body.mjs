...
const BUILD_SPECS = {
  m: {
    ...
    upperArm: { far: [[45, 79, -5], [41.5, 92, -5], 3.1, 2.8], near: [[77, 79, 4], [82, 92, 5], 3.3, 2.9] },
    forearm: { far: [[41.5, 92, -5], [41, 103, -3], 2.8, 2.4], near: [[82, 92, 5], [82.5, 103, 7], 2.9, 2.5] },
    hand: { far: [[41.5, 106, -2], [2.8, 3.5, 2.6]], near: [[82, 106, 8], [3, 3.7, 2.8]] },
  ...
  f: {
    ...
    upperArm: { far: [[47, 80, -5], [43.5, 92, -5], 2.7, 2.4], near: [[75, 80, 4], [79.5, 92, 5], 2.9, 2.5] },
    forearm: { far: [[43.5, 92, -5], [43, 103, -3], 2.4, 2], near: [[79.5, 92, 5], [80, 103, 7], 2.5, 2.1] },
    hand: { far: [[43.5, 106, -2], [2.5, 3.2, 2.4]], near: [[79.5, 106, 8], [2.7, 3.4, 2.5]] },
